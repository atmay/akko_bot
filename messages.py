...
def get_grocery_msg():
    msg = 'Здесь будет инфа про супермаркеты и другие магазы с едой'
    return text(msg)


def get_appliances_msg():
    msg = 'Здесь будет инфа про магазы с бытовой техникой'
    return text(msg)


def get_home_goods_msg():
    msg = 'Здесь будет инфа про магазы с товарами для дома'
    return text(msg)
